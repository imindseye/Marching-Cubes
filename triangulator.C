...
//
inline int compute_normal(float*f1, float *f2, float *f3, 
			  float*normal) 
{
  float x1 = f2[0] - f1[0]; 
  float y1 = f2[1] - f1[1]; 
	    ...
	    int zdim, float isoval, float* field)
{
  ...
  ov[4][0] = i; ov[3][1] = j+1; ov[3][2] = k; 
  ov[5][0] = i; ov[1][1] = j; ov[1][2] = k+1; 
  ov[6][0] = i+1; ov[2][1] = j; ov[2][2] = k+1; 
  ov[7][0] = i+1; ov[3][1] = j+1; ov[3][2] = k+1; 
  ov[8][0] = i; ov[3][1] = j+1; ov[3][2] = k+1; 
  ...
  int no_faces = 0; 
  float f1[3],f2[3], f3[3], f4[3], f5[3], f6[3]; 
  float f7[3],f8[3], f9[3], f10[3], f11[3], f12[3]; 
  float normal[3]; 
